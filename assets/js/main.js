...
function writeUserData(userId, nome, email, cpf, pet, telefone, endereco, cep, cidade, estado, universidad, alojamento, restricao) {
  firebase.database().ref('users/' + userId).set({
    ...
    if (error) {
      ...
      alert("Para efetuar a sua inscrição, faça a transferência de R$130,00 (em até 3 dias úteis) para a seguinte conta bancária:");
      ...
      document.getElementById("mensagemPagamento").innerHTML = "<p>Banco do Brasil</p><p>Agẽncia: 2995-5</p><p>Conta Bancária: 44001-9</p><p>Titular: Alexandre Cabral Bedeschi</p>"
    }
  });
}
